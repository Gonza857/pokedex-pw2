...
$imagen = 'imagenes-pokemon/' . $resultadoConvertido["IMAGEN"];
...
<main class="col-12 d-flex justify-content-center align-items-center">
    <!--  WRAPPER  -->
    <div class="col-4 mx-auto d-flex flex-column gap-2 p-2 justify-content-center align-items-center pokemonCard">
        <div class="pokemonImageContainer">
            <img class="w-50" src="<?= $imagen; ?>" alt="<?= ucfirst($resultadoConvertido['NOMBRE']); ?>">
        </div>
        <div class="d-flex flex-column gap-2 px-4 pb-4">
            ...
            <div class="d-flex gap-2 flex-wrap">
                    <img src="<?= $tipo  ?>" class="w-25 m-0 rounded-circle"   alt="<?= ucfirst($resultadoConvertido['NOMBRE']); ?>">
            </div>
